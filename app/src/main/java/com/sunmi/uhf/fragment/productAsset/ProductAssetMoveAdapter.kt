...
class ProductAssetMoveAdapter(
    private var items: List<ProductAssetMoveItem>,
    private val onScanClick: (ProductAssetMoveItem) -> Unit
) : RecyclerView.Adapter<ProductAssetMoveAdapter.ViewHolder>() {

    @SuppressLint("NotifyDataSetChanged")
    fun updateData(newItems: List<ProductAssetMoveItem>) {
        items = newItems
